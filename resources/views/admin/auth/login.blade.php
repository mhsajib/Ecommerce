...
{{--
                ...
                <div class="center_content">
                    ...
                    <form action="{{route('admin.login')}}" class="d-block" method="post">
                        ...
                        <div class="form-group icon_parent">
                            ...
                            <span class="icon_soon_bottom_right"><i class="fas fa-envelope"></i></span> @error('email')
    ...
    <div class="d-flex align-items-center justify-content-center bg-sl-primary ht-100v">
        ...
        <div class="login-wrapper wd-300 wd-xs-350 pd-25 pd-xs-40 bg-white">
            <div class="signin-logo tx-center tx-24 tx-bold tx-inverse">Dapple Park<span class="tx-info tx-normal">-Admin</span></div>
            <div class="tx-center mg-b-60">Ecommerce Admin Template Design</div>
