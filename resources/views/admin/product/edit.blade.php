                    ...
                    <div class="row mg-b-25">
                        ...
                        <div class="col-lg-6">
                            <div class="form-group mg-b-10-force">
                                ...
                                <select class="form-control select2" data-placeholder="Choose country" name="brand_id">
                                    ...
                                    @endforeach
                                    {{-- <option value="{{ $product->id }}">{{ $product->brand->brand_name }}</option>
                                    --}}
                                    {{-- @endforeach --}}
                                </select>
                            </div>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                ...
                                <input class="form-control-override" type="text" name="product_size" id="size"
                    ...
                    {{ $product->product_details}}
                        ...
                        <div class="col-lg-4">
                            ...
                            <label class="custom-file">
                                ...
                                <img src="{{URL::to($product->image_one)}}" id="one"  height="60px" width="60px">
                            </label>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <label class="custom-file">
                                ...
                                <span class="custom-file-control"></span>
                            <img src="{{URL::to($product->image_two)}}" id="two" height="60px" width="60px">
                            </label>
                        </div>
                        <div class="col-lg-4">
                            ...
                            <label class="custom-file">
                                ...
                                <span class="custom-file-control"></span>
                                <img src="{{URL::to($product->image_three)}}" id="three"  height="60px" width="60px">
                            </label>
                        </div>
                    </div><!-- row -->
                    <br>
