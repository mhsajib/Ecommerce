...
<div class="sl-mainpanel">
    ...
    <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
            <h6 class="card-body-title mb-4">Post List
                ...
                <table id="datatable1" class="table display responsive nowrap">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td> <img src="{{ URL::to($row->post_image)}}" alt="post_image" height="50px" width="50px"></td>

                            <td>
                                <a href=" {{ route('edit.post', $row->id) }} " class="btn btn-sm btn-info" title="Edit" ><i class="fa fa-edit"></i></a>
                                <a href=" {{ route('delete.post', $row->id) }} " class="btn btn-sm btn-danger" id="delete" title="Delete"><i class="fa fa-trash"></i></a>
                                </td>
                        </tr>
                        {{-- @php($i++) --}}
